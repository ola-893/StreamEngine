...
const API_BASE = (import.meta.env.VITE_GATEWAY_URL || "http://localhost:3001").replace(/\/+$/, "");
...
/** Agent — matches backend schema exactly (aligned with autonomous payment flow) */
export interface Agent {
  ...
  remainingBalanceMist?: number;
  /** Agent's own Sui wallet address (generated by backend on creation) */
  walletAddress?: string;
  /** List of connected premium endpoint IDs */
  connectedEndpoints?: string[];
  /** Current wallet balance in SUI (fetched on demand) */
